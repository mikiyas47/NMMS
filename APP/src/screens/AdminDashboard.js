...
const AdminDashboard = ({ navigation }) => {
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'product':
        return <AddProductScreen C={C} />;
      case 'report':
        return <ReportScreen C={C} />;
      default:
        return <OverviewScreen C={C} />;
    }
  };
    ...
    <SafeAreaView className="flex-1" style={{ backgroundColor: C.bg }}>
      ...
      <LinearGradient colors={C.gradBg} className="flex-1">
        ...
        >
          ...
          <View className="flex-row items-center" style={{ gap: 8 }}>
            ...
            <TouchableOpacity
              ...
              style={{ backgroundColor: C.card, borderWidth: 1, borderColor: C.border }}
            >
              <Bell color={C.text} size={18} />
              <View className="absolute w-2 h-2 rounded-full top-1.5 right-1.5" style={{ backgroundColor: C.red }} />
            </TouchableOpacity>
            {/* Logout */}
            <TouchableOpacity
        ...
        >
          ...
          >
            {/* Brand */}
            <LinearGradient colors={['#6366F1', '#8B5CF6']} className="flex-row items-center px-5 pb-6" style={{ paddingTop: Platform.OS === 'android' ? 50 : 55 }} start={[0, 0]} end={[1, 1]}>
              ...
              <View>
                ...
                <Text className="text-white/70 text-xs">Admin Console</Text>
              </View>
            </LinearGradient>
