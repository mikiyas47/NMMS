...
with open('app/src/screens/distributor/ProspectsScreen.js', 'r', encoding='utf-8') as f:
    content = f.read()

start_marker = 'const InviteFlowModal = ({ visible, prospect, onClose, onSaved, C }) => {'
end_marker = '// ── Shared sub-components'
...
post_content = end_marker + end_parts[1]

new_modal = """const InviteFlowModal = ({ visible, prospect, onClose, onSaved, C }) => {
...
with open('app/src/screens/distributor/ProspectsScreen.js', 'w', encoding='utf-8') as f:
    f.write(pre_content + new_modal + post_content)
